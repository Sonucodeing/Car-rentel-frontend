    ...
    <motion.div
            ...
            transition={{ duration: 0.6}}
                ...
                <div className='max-w-80'>
                    ...
                    src={assets.logo} alt="logo" className=' h-8 md:h-' />
                    <motion.p
                    initial={{opacity: 0}}
                    whileInView={{opacity: 1}}
                    transition={{ duration: 0.4, delay: 0.4}}
                    className='max-w-80 mt-3'>
                        Premium CarRental service with a wide selection of luxury and everday vehicles for all your driving needs.
                    </motion.p>
                    <motion.div
                    initial={{opacity: 0}}
                    whileInView={{opacity: 1}}
                ...
                <div>
                    <h2 className='text-base font-medium uppercase text-gray-800'>contect</h2>
                    <ul className='mt-3 flex flex-col gap-1.5 '>
                        <li><a href="#">1234 Luxury Drive</a></li>
                        <li><a href="#">San Francisco, CA 94107</a></li>
                        <li><a href="#">+91 23456456</a></li>
