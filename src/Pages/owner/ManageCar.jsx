...
const ManageCar = () => {
  ...
  const toggleAvailability = async (carId)=>{
   ...
   const deleteCar = async (carId)=>{
    try{
      ...
      const confirm = window.confirm('Are you sure you wnat to delete this car?')
  ...
  return (
    ...
    <Title title='Manage Cars' subtitle='View all listed cars, update thier detilas, or remove them from the booking platfrom.'/>
