  ...
  return (
   <>
    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title="Add new car" subtitle="Fill in detials to list a new car for booking, including pricing, availability, and car specification."/>

      <form onSubmit={onsubmitHandler} className='flex flex-col gap-5 text-gray-500text-sm mt-6 max-w-xl'>
             ...
             <div className='flex flex-col w-full'>
              ...
              {/* Car Description */}
               ...
               <div className='flex flex-col w-full'>
                ...
                <textarea rows={5}  placeholder='e.g. A luxurios SUV with a spacious interrior and a powerfull engine' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=> setCar({...car, description: e.target.value})}></textarea>
            </div>

            <button className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer'>
              <img src={assets.tick_icon} alt="" />
             {isLoading ? 'Lisiting...' : 'List Your Car'}
            </button>
